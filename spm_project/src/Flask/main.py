...
learning_journey_detailed = db.Table('learning_journey_detailed',
    db.Column('learningjourney_id',db.Integer,db.ForeignKey('Learningjourney.learningjourney_id')),
    db.Column('course_id',db.Integer,db.ForeignKey('Course.course_id'))
)
...
class Skill(db.Model):
    ...
    skills_to_course = db.relationship('Course', secondary="user_channel",backref="skilltocourse")
...
class Staff(db.Model):
    ...
    learningjourneys = db.relationship('Learningjourney',backref='learningjourney')
...
class Learningjourney(db.Model):
    ...
    jobrole_id = db.Column(db.Integer, db.ForeignKey("Jobrole.jobrole_id"))
...
class Registration(db.Model):
    ...
    course_id = db.Column(db.Integer, primary_key=True)
    staff_id = db.Column(db.Integer, primary_key=True)
    reg_status = db.Column(db.Integer, primary_key=True)
    complete_status = db.Column(db.Integer, primary_key=True)
